...
const HeaderSection = () => {
    ...
    const headerSX = {
        fontSize: { xs: '2rem', sm: '3rem', md: '3rem', lg: '3rem', color:'#ffff' }
    };
    ...
    return (
        <Container sx={{ height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#131313' }}>
            <Grid
                container
